...
const file_server_proto_rawDesc = "" +
	"\n" +
	"\fserver.proto\x12\x05proto\"\x10\n" +
	"\x0eGetInfoRequest\"G\n" +
	"\x0fGetInfoResponse\x12\x18\n" +
	"\ahostURL\x18\x01 \x01(\tR\ahostURL\x12\x1a\n" +
	"\bproxyURL\x18\x02 \x01(\tR\bproxyURL\"K\n" +
	"\x11CreateUserRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\fR\bpassword\"D\n" +
	"\x12CreateUserResponse\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06addrID\x18\x02 \x01(\tR\x06addrID\"+\n" +
	"\x11RevokeUserRequest\x12\x16\n" +
	...
	"\x15CreateAddressResponse\x12\x16\n" +
	"\x06addrID\x18\x01 \x01(\tR\x06addrID\"F\n" +
	"\x14RemoveAddressRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06addrID\x18\x02 \x01(\tR\x06addrID\"\x17\n" +
	"\x15RemoveAddressResponse\"\x82\x01\n" +
	"\x12CreateLabelRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bparentID\x18\x03 \x01(\tR\bparentID\x12$\n" +
	"\x04type\x18\x04 \x01(\x0e2\x10.proto.LabelTypeR\x04type\"/\n" +
	"\x13CreateLabelResponse\x12\x18\n" +
	"\alabelID\x18\x01 \x01(\tR\alabelID*\"\n" +
	"\tLabelType\x12\n" +
	"\n" +
	"\x06FOLDER\x10\x00\x12\t\n" +
	"\x05LABEL\x10\x012\xa6\x03\n" +
	"\x06Server\x128\n" +
	"\aGetInfo\x12\x15.proto.GetInfoRequest\x1a\x16.proto.GetInfoResponse\x12A\n" +
	"\n" +
	"CreateUser\x12\x18.proto.CreateUserRequest\x1a\x19.proto.CreateUserResponse\x12A\n" +
	"\n" +
	"RevokeUser\x12\x18.proto.RevokeUserRequest\x1a\x19.proto.RevokeUserResponse\x12J\n" +
	"\rCreateAddress\x12\x1b.proto.CreateAddressRequest\x1a\x1c.proto.CreateAddressResponse\x12J\n" +
	"\rRemoveAddress\x12\x1b.proto.RemoveAddressRequest\x1a\x1c.proto.RemoveAddressResponse\x12D\n" +
	"\vCreateLabel\x12\x19.proto.CreateLabelRequest\x1a\x1a.proto.CreateLabelResponseB/Z-github.com/mort666/go-proton-api/server/protob\x06proto3"
